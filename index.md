...
<section class="hero">
  ...
  <div class="hero-content">
    ...
    <div class="hero-text">
      ...
      <h1 class="hero-title">
        Bonjour, je suis<br/>
        <span class="hero-name">Benoît Rongeard</span>
      </h1>
      ...
      <div class="hero-description">
        ...
        <div class="meta-item">
          <span class="meta-icon">📍</span>
          <span class="meta-text">France</span>
        </div>
        <div class="meta-item">
          <span class="meta-icon">💼</span>
  ...
  <div class="container">
    ...
    <div class="bento-grid">
      ...
      <div class="bento-card span-7">
        <h3 class="bento-card-title">Full Stack Development</h3>
      ...
      <div class="bento-card span-5">
        ...
        <h3 class="bento-card-title">Databases</h3>
        <div class="tech-icons">
      ...
      <div class="bento-card span-5">
        <h3 class="bento-card-title">Frontend & UI</h3>
        <div class="tech-icons">
      ...
      <div class="bento-card span-5">
        <h3 class="bento-card-title">Web3</h3>
        <div class="tech-icons">
        ...
        <h3 class="bento-card-title">Dev Tools</h3>
        <div class="tech-icons">
